"""
Django settings for FlexyCalendarAPI project.
...
SECRET_KEY = SecurityConfigurations.SECRET_KEY
...
WSGI_APPLICATION = 'FlexyCalendarAPI.wsgi.application'
...
DATABASES = SecurityConfigurations.DATABASES
